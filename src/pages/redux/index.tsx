...
import { usePersonContext, Provider } from "../../stores/redux";
...
const Info = observer(() => {
    const { selectedPerson } = usePersonContext("selectView");
    return (
        <div className="w-1/3 ml-10 mt-2">
            <p>
                Idade:{" "}
...
const Redux: NextPage<ReduxProps> = ({}) => {
    return (
        <Provider>
            <div className="max-w-7xl mt-6 mx-auto px-2 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-semibold">Redux State Tree</h2>
